package PunimiSeminarik;
/* This code help us to calculate the probability of the road that makes the mouse in the labyrinth to reach the food hall
 *  Look at Example3 in 10.4. Applications of Numerical Methods.pdf */
...
public class ProbabilitetiGaussSeidel {
    ...
    public void zgjidhja() {
        ...
        Arrays.fill(X, 0);// vektori fillestar 0
        ...
        while (true) {
            ...
            if (stop || iterations ==  NR_MAX_ITERACIONEC ) {
            	System.out.println("Metoda konvergjon pas "+iterations+" iteracionesh");
